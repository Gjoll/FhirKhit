        ...
        void CreateUSMassPosteriorAcousticFeatures()
        {
            ...
            SDefEditor e = this.CreateEditor("BreastRadUSMassPosteriorAcousticFeatures",
                    ...
                    .Description(new Markdown()
                        ...
                        .BiradHeader()
                        .BiRadLine("Posterior acoustic features represent the attenuation characteristics of a mass with respect to its")
                        .BiRadLine("acoustic transmission. Attenuation (shadowing) and enhancement are additional attributes of")
                        .BiRadLine("masses, mostly of secondary rather than primary predictive value..")
                        .BiradFooter()
                        )
