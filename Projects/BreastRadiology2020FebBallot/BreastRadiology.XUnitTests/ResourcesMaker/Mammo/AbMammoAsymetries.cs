...
namespace BreastRadiology.XUnitTests
{
    ...
    {
        String AbMammoAsymetries()
        {
            String binding = this.CreateValueSet(
                    "BreastRadAsymetries",
                    "Breast Radiology Asymetries",
                    new Markdown()
                        .Paragraph("Breast Radiology Mammography Asymetries"),
                   new ConceptDef[]
                    {
            ...
            SDefEditor e = this.CreateObservationEditor("BreastRadAbnormalityMammoAsymetries",
                        "Breast Radiology Abnormality Asymetries (Mammography)",
                        new string[] {"Asymetries"})
                    .Description(new Markdown()
                        .Paragraph("Mammography Breast Abnormality Asymetries Observation")
                        .BiradHeader()
