    ...
    public partial class ResourcesMaker : ConverterBase
    {
        String FindingMammoAsymmetries()
        {
            String binding = this.CreateValueSet(
                    ...
                    "Breast Radiology Asymmetries",
                    new Markdown()
                        .Paragraph("Breast Radiology Mammography Asymmetries"),
                   new ConceptDef[]
                    {
            ...
            SDefEditor e = this.CreateObservationEditor("BreastRadFindingMammoAsymmetries",
                        "Breast Radiology Finding Asymmetries (Mammography)",
                        new string[] {"Asymmetries"})
                    .Description(new Markdown()
                        .Paragraph("Mammography Breast Finding Asymmetries Observation")
                        .Paragraph("If this observation is present, and dataAbsentReason is empty, then an asymmetry was observed.")
                        .Paragraph("If this observation is present, and dataAbsentReason is not empty, then an asymmetry " +
