        ...
        void CreateFindingMammo()
        {
            SDefEditor e = this.CreateEditor("BreastRadMammoFinding",
                ...
                .Description(new Markdown()
                            ...
                            .BiradHeader()
                            .BiRadLine("A \"MASS\" is three dimensional and occupies space. It is seen on two different mammographic pro-")
                            .BiRadLine("jections. It has completely or partially convex-outward borders and (when radiodense) appears")
                            .BiRadLine("denser in the center than at the periphery. If a potential mass is seen only on a single projection, it")
                            .BiRadLine("should be called an \"ASYMMETRY\" until its 3-dimensionality is confirmed (See Section D on Asym-")
                            .BiRadLine("metries and also the Guidance chapter). (Insert links/page #s)")
                            .BiradFooter()
                            )
