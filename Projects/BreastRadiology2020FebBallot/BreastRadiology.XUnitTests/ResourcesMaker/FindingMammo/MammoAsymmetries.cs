        ...
        void CreateMammoAsymmetries()
        {
            ...
            SDefEditor e = this.CreateEditor("BreastRadMammoAsymmetries",
                    ...
                    .Description(new Markdown()
                        ...
                        .BiradHeader()
                        .BiRadLine("The several types of asymmetry involve a spectrum of mammographic findings that represent")
                        .BiRadLine("unilateral deposits of fibroglandular tissue not conforming to the definition of a radiodense mass.")
                        .BiRadLine("The asymmetry, unlike a mass, is visible on only 1 mammographic projection. The other 3 types of")
                        .BiRadLine("asymmetry, although visible on more than 1 projection, have concave-outward borders and usu-")
                        .BiRadLine("ally are seen to be interspersed with fat, whereas a radiodense mass displays completely or partially")
                        .BiRadLine("convex-outward borders and appears to be denser in the center than at the periphery.")
                        .BiradFooter()
                        )
