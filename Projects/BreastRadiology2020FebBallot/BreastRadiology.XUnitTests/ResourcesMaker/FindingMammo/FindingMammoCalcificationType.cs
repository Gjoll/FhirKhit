...
namespace BreastRadiology.XUnitTests
{
    ...
    {
        String FindingMammoCalcificationType
        {
            get
            {
                if (findingMammoCalcificationType == null)
                    findingMammoCalcificationType = CreateFindingMammoCalcificationType();
                return findingMammoCalcificationType;
            }
        }
        String findingMammoCalcificationType = null;

        String CreateFindingMammoCalcificationType()
        {
            ...
            SDefEditor e = this.CreateObservationEditor("BreastRadFindingMammoCalcificationType",
                        "Breast Radiology Finding Calcification Type (Mammography)",
                    new string[] { "Type" })
                    .Description(new Markdown().Paragraph("Mammography Breast Finding Calcification Type Observation"))
