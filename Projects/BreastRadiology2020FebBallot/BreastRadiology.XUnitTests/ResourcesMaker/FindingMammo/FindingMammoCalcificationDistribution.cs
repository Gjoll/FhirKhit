...
namespace BreastRadiology.XUnitTests
{
    ...
    {
        String FindingMammoCalcificationDistribution
        {
            get
            {
                if (findingMammoCalcificationDistribution == null)
                    findingMammoCalcificationDistribution = CreateFindingMammoCalcificationDistribution();
                return findingMammoCalcificationDistribution;
            }
        }
        String findingMammoCalcificationDistribution = null;

        String CreateFindingMammoCalcificationDistribution()
        {
            ...
            SDefEditor e =  this.CreateObservationEditor("BreastRadFindingMammoCalcificationDistribution",
                    "Breast Radiology Finding Calcification Distribution (Mammography)",
                    new string[] {"Distribution"})
                .Description(new Markdown().Paragraph("Mammography Breast Finding Calcification Distribution Observation"))
