    ...
    public partial class ResourcesMaker : ConverterBase
    {
        ...
        String CreateFindingMammoMassDensity()
        {
            String binding = this.CreateValueSet(
                ...
                "Breast Radiology Finding Mammography Mass Density",
                new Markdown()
            ...
            SDefEditor e = this.CreateObservationEditor("BreastRadFindingMammoMassDensity",
                        "Breast Radiology Finding Mass Density (Mammography)",
                        new string[] { "Density" })
                    .Description(new Markdown()
                        .Paragraph("Breast Radiology Finding Mass Density Observation (Mammography)")
                        .Paragraph("If this observation is present, and dataAbsentReason is empty, then an mass density was observed.")
                        .Paragraph("If this observation is present, and dataAbsentReason is not empty, then an mass density " +
