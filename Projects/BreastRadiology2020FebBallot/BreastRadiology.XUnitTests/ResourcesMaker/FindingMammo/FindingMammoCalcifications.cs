...
namespace BreastRadiology.XUnitTests
{
    ...
    {
        String FindingMammoCalcifications(String calcType,
            String calcDistribution)
        {
            SDefEditor e = this.CreateObservationEditor("BreastRadFindingMammoCalcifications",
                    "Breast Radiology Finding Mammography Calcifications Observation",
                    new string[] {"Calcifications"})
                .Description(
                    new Markdown()
                        .Paragraph("Breast Radiology Finding Mammography Calcifications Observation")
...

            {
                ...
                {
                    new ProfileTarget(calcType, 0, "1"),
                    new ProfileTarget(calcDistribution, 0, "1")
                };
