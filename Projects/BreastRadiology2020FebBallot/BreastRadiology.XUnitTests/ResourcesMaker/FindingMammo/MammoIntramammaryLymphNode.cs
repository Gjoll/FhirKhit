        ...
        void CreateMammoIntramammaryLymphNode()
        {
            SDefEditor e = this.CreateEditor("BreastRadMammoIntramammaryLymphNode",
                    ...
                    .Description(new Markdown()
                        ...
                        .BiradHeader()
                        .BiRadLine("These are circumscribed masses that are reniform and have hilar fat. They are generally 1 cm or smaller")
                        .BiRadLine("in size. They may be larger than 1 cm and characterized as normal when fat replacement is pro-")
                        .BiRadLine("nounced. They frequently occur in the lateral and usually upper portions of the breast closer to the")
                        .BiRadLine("axilla, although they may occur anywhere in the breast. They usually are seen adjacent to a vein,")
                        .BiRadLine("because the lymphatic drainage of the breast parallels the venous drainage.")
                        .BiradFooter())
