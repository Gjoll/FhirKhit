        ...
        void CreateMammoAxillaryAdenopathy()
        {
            SDefEditor e = this.CreateEditor("BreastRadMammoAxillaryAdenopathy",
                    ...
                    .Description(new Markdown()
                        ...
                        .BiradHeader()
                        .BiRadLine("Enlarged axillary lymph nodes may warrant comment, clinical correlation, and additional ")
                        .BiRadLine("evaluation, especially if new or considerably larger or rounder when compared to previous examination.")
                        .BiRadLine("A review of the patient’s medical history may elucidate the cause for axillary adenopathy, averting")
                        .BiRadLine("recommendation for additional evaluation. When one or more large axillary nodes are ")
                        .BiRadLine("substantially composed of fat, this is a normal variant.")
                        .BiradFooter()
                    )
