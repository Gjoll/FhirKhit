        ...
        void CreateMammoSkinThickening()
        {
            SDefEditor e = this.CreateEditor("BreastRadMammoSkinThickening",
                ...
                .Description(new Markdown()
                    ...
                    .BiradHeader()
                    .BiRadLine("Skin thickening may be focal or diffuse, and is defined as being greater than 2 mm in thickness. This ")
                    .BiRadLine("finding is of particular concern if it represents a change from previous mammography examinations. ").BiRadLine("However, unilateral skin thickening is an expected finding after radiation therapy.")
                    .BiradFooter()
                )
