        ...
        void CreateMammoNippleRetraction()
        {
            SDefEditor e = this.CreateEditor("BreastRadMammoNippleRetraction",
                    ...
                    .Description(new Markdown()
                        ...
                        .BiradHeader()
                        .BiRadLine("The nipple is pulled in. This should not be confused with nipple inversion, which is often bilateral ")
                        .BiRadLine("and which in the absence of any suspicious findings and when stable for a long period of time, ")
                        .BiRadLine("is not a sign of malignancy. However, if nipple retraction is new, suspicion for underlying malignancy is increased.")
                        .BiradFooter()
                    )
