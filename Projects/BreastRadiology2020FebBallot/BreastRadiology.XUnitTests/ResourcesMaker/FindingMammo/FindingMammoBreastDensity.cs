...
namespace BreastRadiology.XUnitTests
{
    public partial class ResourcesMaker : ConverterBase
    {
        ...
        String CreateFindingMammoBreastDensity()
        {
            ...
            SDefEditor e = this.CreateObservationEditor("BreastRadFindingMammoBreastDensity",
                        "Breast Radiology Finding Breast Density (Mammography)",
                        new string[] {"Breast","Density"})
                    .Description(new Markdown()
                        .Paragraph("Mammography Breast Finding Breast Density Observation")
                        .BiradHeader()
