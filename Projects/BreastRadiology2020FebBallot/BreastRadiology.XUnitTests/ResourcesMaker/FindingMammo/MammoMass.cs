        ...
        void CreateMammoMass()
        {
            SDefEditor e = this.CreateEditor("BreastRadMammoMass",
                ...
                .Description(new Markdown()
                    ...
                    .BiradHeader()
                    .BiRadLine("\"MASS\" is three dimensional and occupies space. It is seen on two different mammographic pro-")
                    ...
                    .BiRadLine("should be called an \"ASYMMETRY\" until its 3-dimensionality is confirmed")
                    .BiradFooter()
