        ...
        void CreateMammoSolitaryDilatedDuct()
        {
            SDefEditor e = this.CreateEditor("BreastRadMammoSolitaryDilatedDuct",
                ...
                .Description(new Markdown()
                    ...
                    .BiradHeader()
                    .BiRadLine("This is a unilateral tubular or branching structure that likely represents a dilated or otherwise en-")
                    .BiRadLine("larged duct. It is a rare finding. Even if unassociated with other suspicious clinical or mammographic")
                    .BiRadLine("findings, it has been reported to be associated with noncalcified DCIS.")
                    .BiradFooter()
                )
