        ...
        void CreateMammoMassDensity()
        {
            ...
            SDefEditor e = this.CreateEditor("BreastRadMammoMassDensity",
                    ...
                    .Description(new Markdown()
                        ...
                        .BiradHeader()
                        .BiRadLine("Radiographic density is considered an important feature in the evaluation of noncalcified breast masses, yet")
                        .BiRadLine("no studies assessing its value have been published. The radiographic densities of 91 biopsy-proved, nonfatty,")
                        .BiRadLine("noncalcified breast masses were evaluated by three mammographers. The density determinations made by")
                        .BiRadLine("each observer were compared with the histologic outcome for the 51 benign and 40 malignant lesions. With")
                        .BiRadLine("the kappa statistic, interobserver agreement was relatively poor (0.22 to 0.49), and intraobserver agreement for")
                        .BiRadLine("one expert mammographer was 0.50. When the majority opinion of the mammographers was used, sensitivity")
                        .BiRadLine("was 48%, specificity was 80%, and both positive and negative predictive values were 66%. As a solitary feature")
                        .BiRadLine("in lesion analysis, mammographic density is difficult to assess and is of limited value for the prediction of the")
                        .BiRadLine("benign or malignant nature of noncalcified breast masses.")
                        .BiradFooter()
                        )
