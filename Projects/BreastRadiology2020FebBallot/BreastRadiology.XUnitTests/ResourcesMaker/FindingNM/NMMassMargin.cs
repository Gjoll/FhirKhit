...
namespace BreastRadiology.XUnitTests
{
    partial class ResourcesMaker : ConverterBase
    {
        ...
        {
            if (nmMassMargin == null)
                await CreateNMMassMargin();
            return nmMassMargin;
        }
        ...
        async VTask CreateNMMassMargin()
        {
            await VTask.Run(async () =>
            {
                ValueSet binding = this.CreateValueSet(
                    ...
                    "NM Mass Margin",
                    new string[] { "NM", "Mass", "Margin", "Values" },
                ...
                e.IntroDoc.ReviewedStatus(ReviewStatus.NotReviewed).CodedObservationLeafNode(e, "a NM mass margin", binding);
            });
        }
    }
}
