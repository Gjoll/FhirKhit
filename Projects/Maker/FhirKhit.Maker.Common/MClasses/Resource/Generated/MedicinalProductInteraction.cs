...
{                                                                                                                                           // MakerGen.cs:406
    ...
    public class MedicinalProductInteraction : FhirKhit.Maker.Common.Resource.ResourceBase                                                  // MakerGen.cs:360
    {                                                                                                                                       // MakerGen.cs:361
        // 3. MedicinalProductInteraction.interactant
        public class Type_Interactant : FhirKhit.Maker.Common.Complex.ComplexBase                                                           // MakerGen.cs:360
        {                                                                                                                                   // MakerGen.cs:361
            // 4. MedicinalProductInteraction.interactant.item[x]
            public MakerElementInstance Element_Item;                                                                                       // MakerGen.cs:232
            public Type_Interactant()                                                                                                       // MakerGen.cs:369
            {                                                                                                                               // MakerGen.cs:370
                {                                                                                                                           // MakerGen.cs:243
                    // 4. MedicinalProductInteraction.interactant.item[x]
        ...
        public MedicinalProductInteraction()                                                                                                // MakerGen.cs:369
        {                                                                                                                                   // MakerGen.cs:370
            {                                                                                                                               // MakerGen.cs:243
                // 1. MedicinalProductInteraction.subject
