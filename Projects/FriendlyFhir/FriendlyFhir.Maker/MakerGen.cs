...
namespace FriendlyFhir.Maker
{
    public class MakerGen : ConverterBase, IDisposable
    {
        ...
        public MakerGen(String outputDir)
        {
            ...
            FhirStructureDefinitions.Create(Path.Combine(outputDir, "Cache"));
        }
        ...
        void LoadFhirElement(StructureDefinition sDef)
        {
            ...
            {
                this.ConversionInfo(this.GetType().Name, fcn, $"Skipping resource derived {sDef.Name} (parent {sDef.Type}");
                return;
            }
        ...
        void LoadFhirElements()
        {
            ...
            foreach (StructureDefinition sDef in FhirStructureDefinitions.Self.FhirSDefs.GetResources())
            {
                ...
                {
                    this.ConversionWarn(this.GetType().Name, fcn, $"Load failed '{sDef.Name}. {err.Message}");
                }
            }
        }
        ...
        void ProcessFhirPrimitive(SDefInfo sDefInfo)
        {
            ...
            this.ConversionInfo(this.GetType().Name, fcn, $"Processing Primitive {sDef.Name}");
        ...
        void ProcessFhirResource(SDefInfo sDefInfo)
        {
            ...
            this.ConversionInfo(this.GetType().Name, fcn, $"Processing Resource {sDef.Name}");
        ...
        void ProcessFhirComplex(SDefInfo sDefInfo)
        {
            ...
            this.ConversionInfo(this.GetType().Name, fcn, $"Processing Complex {sDef.Name}");
