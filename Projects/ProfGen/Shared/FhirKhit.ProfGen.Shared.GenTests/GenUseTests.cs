...
namespace FhirKhit.ProfGen.GenTests
{
    ...
    public class GenUseTests
    {
        ...
        public void CardinalityModObservationTest()
        {
            ...
            CardinalityModObservation n = new CardinalityModObservation(o);
        ...
        public void FixedTest()
        {
            ...
            {
                FixedObservation n = new FixedObservation(o);
                {
            ...
            {
                FixedObservation1 n = new FixedObservation1(o);
                {
            ...
            {
                FixedObservation2 n = new FixedObservation2(o);
                {
        ...
        public void NoModObservationTest()
        {
            ...
            NoModObservation n = new NoModObservation(o);
            {
                Assert.True(n.Status.Get(out Code<ObservationStatus> status) == true);
                Assert.True(status.Value == ObservationStatus.Cancelled);
            ...
            }
            {
                ...
                Assert.True(n.Identifier.Get().ToArray().Length == 2);
                n.Identifier.AddRange(n.Identifier.Get().ToArray());
                Assert.True(n.Identifier.Count == 4);
            }
