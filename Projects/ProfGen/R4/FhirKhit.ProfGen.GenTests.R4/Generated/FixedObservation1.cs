...
{                                                                               // CSCodeFormatter.cs:84
    ...
    /// Class to implement 'FixedObservation1'                                  // CSClassFormatter.cs:86
    /// </summary>                                                              // CSClassFormatter.cs:87
    public class FixedObservation1 :                                            // CSClassFormatter.cs:88
...
#region Sub Class Definitions
        ...
        {                                                                       // CSClassFormatter.cs:659
            ...
            public bool Get(out FhirDateTime value)                             // CSClassFormatter.cs:670
            {                                                                   // CSClassFormatter.cs:671
                value = (FhirDateTime) this.ptr.Effective;                      // CSClassFormatter.cs:675
        ...
        {                                                                       // CSClassFormatter.cs:659
            ...
            /// </summary>                                                      // CSClassFormatter.cs:669
            public bool Get(out Quantity value)                                 // CSClassFormatter.cs:670
            {                                                                   // CSClassFormatter.cs:671
                value = (Quantity) this.ptr.Value;                              // CSClassFormatter.cs:675
                return value != null;                                           // CSClassFormatter.cs:680
            }                                                                   // CSClassFormatter.cs:681
        }                                                                       // CSClassFormatter.cs:682
                                                                                // CSClassFormatter.cs:909
...
#region Property Definitions
        ...
        public FixedObservation1(Observation ptr) : base(ptr)                   // CSClassFormatter.cs:109
        {                                                                       // CSClassFormatter.cs:110
            {                                                                   // CSClassFormatter.cs:255
                FhirDateTime temp = new FhirDateTime("1002-01-02T03:04:05+00:00");// CSClassFormatter.cs:256
                this.ptr.Effective = temp;                                      // CSClassFormatter.cs:259
            }                                                                   // CSClassFormatter.cs:265
            {                                                                   // CSClassFormatter.cs:255
                Quantity temp = new Quantity(10, "things", "www.things.com");   // CSClassFormatter.cs:256
